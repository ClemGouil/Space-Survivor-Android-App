    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_sell.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                sellObject(object,sharedPreferences.getString("mail",null),sharedPreferences.getString("password",null));
            }
        });

    }

    public void sellObject(Object object,String mail, String password){
        Call<Object> BuyResponseCall = ApiClient.getService().sellObjet(object,mail,password);
        BuyResponseCall.enqueue(new Callback<Object>() {
            @Override
            public void onResponse(Call<Object> call, Response<Object> response) {
                if (response.isSuccessful()){
                    String message = "Successful sale";
                    Toast.makeText(DetailInventoryActivity.this,message,Toast.LENGTH_LONG).show();

                    SharedPreferences.Editor editor = sharedPreferences.edit();
                    editor.putInt("coins",sharedPreferences.getInt("coins",0) + response.body().getPrice());
                    editor.commit();

                    startActivity(new Intent(DetailInventoryActivity.this,InventoryActivity.class));
                    finish();;
                } else {
